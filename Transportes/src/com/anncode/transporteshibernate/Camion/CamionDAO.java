...
public class CamionDAO{
	...
	public void insertar(Camion camion, Session session){
		try{
			...
			System.err.println("****** MATRICULA : " + camion.getMatricula());
			he.printStackTrace();
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	public Camion obtenerRegistrosPorID(int id, Session session){
		Camion camion = null;
		try{
	...
	public List<Camion> obtenerTodosRegistros(Session session){
		...
		try{
			...
			System.err.println("****** ERROR AL OBTENER TODOS LOS CAMIONES");
			he.printStackTrace();
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	public List<Camion> obtenerRegistrosParamtros(HashMap<String, Object> parametros, Session session){
		...
		try{
			...
			System.err.println("****** ERROR AL OBTENER LOS CAMIONES POR PARAMETROS");
			he.printStackTrace();
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	public int actualizar(Camion camion, Session session){
		...
		try{
			...
			System.err.println("****** ERROR AL ACTUALIZAR EL CAMION");
			System.err.println("****** ID        : " + camion.getId());
			he.printStackTrace();
		}catch(Exception e){
			e.printStackTrace();
	...
	public int actualizar(HashMap<String, Object> parametros, HashMap<String, Object> filtros, Session session){
		...
		try{
			...
			System.err.println("****** ERROR AL ACTUALIZAR LOS CAMIONES POR PARAMETROS");
			he.printStackTrace();
		}catch(Exception e){
			e.printStackTrace();
		}
	...
	public void eliminar(Camion camion, Session session){
		...
		try{
			...
			System.err.println("****** ERROR AL ELIMINAR CAMION POR ID");
			System.err.println("****** ID        : " + camion.getId());
			he.printStackTrace();
		}catch(Exception e){
			e.printStackTrace();
